...
@Component({
  selector: 'app-revenues-button',
  templateUrl: './revenues-button.component.html',
  styleUrls: ['./revenues-button.component.scss']
})
export class RevenuesButtonComponent implements OnInit, AfterViewInit {
