...
@Component({
  selector: 'app-debts-button',
  templateUrl: './debts-button.component.html',
  styleUrls: ['./debts-button.component.scss']
})
export class DebtsButtonComponent implements OnInit, AfterViewInit {
  user!: string;
  loading = false;
  emptyResult = false;
  arrDebts: any;
